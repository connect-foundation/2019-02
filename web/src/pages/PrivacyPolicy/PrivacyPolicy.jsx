...
Dropy는 개인정보 보호법 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립․공개합니다. 
...
제3조(개인정보의 제3자 제공)
  ...
  ② 회사는 다음과 같이 개인정보를 제3자에게 제공하지 않습니다.
...
제9조(개인정보 자동 수집 장치의 설치∙운영 및 거부에 관한 사항)
  ① 회사는 이용자에게 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고 수시로 불러오는 ‘토큰’을 사용합니다.
  ② 토큰(jsonwebtoken)는 웹사이트를 운영하는데 이용되는 서버(http)가 이용자의 컴퓨터 브라우저에게 보내는 소량의 정보이며 이용자들의 PC 컴퓨터내의 하드디스크에 저장되기도 합니다.
    가. 토큰의 사용목적: 이용자가 방문한 각 서비스와 웹 사이트들에 대한 방문 및 이용형태, 인기 검색어, 보안접속 여부, 등을 파악하여 이용자에게 최적화된 정보 제공을 위해 사용됩니다.
    나. 토큰의 설치∙운영 및 거부 : 웹브라우저 상단의 도구>인터넷 옵션>개인정보 메뉴의 옵션 설정을 통해 토큰 저장을 거부 할 수 있습니다.
    다. 토큰 저장을 거부할 경우 맞춤형 서비스 이용에 어려움이 발생할 수 있습니다.
제10조(개인정보 보호책임자)
...
제13조(영상정보처리기기 설치․운영)
  영상정보처리기기를 설치, 운영하고 있지 않습니다.

제14조(개인정보 처리방침 변경)
  ① 이 개인정보 처리방침은 2019. 11. 29부터 적용됩니다.
`}
      </S.Content>
    </S.Inner>
  </S.PrivacyPolicy>
