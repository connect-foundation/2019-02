...
export const GET_FLYING_EMOJI_SPEED = () => 3.5 + Math.random() * 8;
export const FULL_SCREEN_SCALE = () => 4.5 + Math.random();
export const NORMAL_SCREEN_SCALE = () => 2 + Math.random();
...
export const PREVENT_FLYING_EMOJI = () => {
  ...
  const maxEmojiCount = () => countFlyingEmoji && countFlyingEmoji > 1000;
